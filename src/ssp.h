...
/* Mensagens */
#define MSG_PING 1
#define MSG_MODO_AUT 2
#define MSG_MODO_MANUAL 3
#define MSG_STOP 4
#define MSG_MOVE 5
#define MSG_ROTATE 6
#define MSG_ALIVE 7
...
extern void csnLow();
extern void csnHi();
extern void writeRegister(uint8_t reg, uint8_t * value, uint8_t len);
extern void setTADDR(uint8_t * adr);
extern void config_rf();
extern void powerUpRx();
extern void flushRx();
extern void setRADDR(uint8_t * adr);
extern void send_rf(uint8_t * value);
extern void powerUpTx();
extern uint8_t isSending();
